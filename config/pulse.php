    ...
    */
    ...
    'recorders' => [
        ...
        Recorders\SlowOutgoingRequests::class => [
            ...
            'threshold' => [
                '#^https://generativelanguage\.googleapis\.com#' => 60_000,
                '#^https://dashscope-intl\.aliyuncs\.com#' => 60_000,
                '#^https://openrouter\.ai#' => 60_000,
            ...
            'groups' => [
                ...
                '#^https://dashscope-intl\.aliyuncs\.com.*$#' => 'DashScope/Qwen',
