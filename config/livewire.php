...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // 50 MB to match Filament maxSize(51200) on menu photo uploads — large
        // files from professional food photography. PHP upload_max_filesize and
        // nginx client_max_body_size are raised accordingly (docker/).
